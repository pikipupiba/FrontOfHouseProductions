    ...
    <main className="bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Have questions or ready to discuss your event production needs? Reach out to our team.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      123 Production Way, Suite 100<br />
                      Nashville, TN 37203
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      info@frontofhouseproductions.com
                    </p>
                    <p className="mt-1 text-gray-500 dark:text-gray-400 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-300">
                      Monday - Friday: 9:00 AM - 6:00 PM CT<br />
                      Saturday: 10:00 AM - 3:00 PM CT<br />
                      Sunday: Closed
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-10 h-64 bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-400"
                    >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Follow Us on Social Media</h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Stay updated on our latest projects and event production tips.
          </p>
