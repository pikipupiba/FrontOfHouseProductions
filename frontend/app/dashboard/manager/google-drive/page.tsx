...
import { GoogleDriveFiles } from '../../employee/google-workspace/GoogleDriveFiles';
...
export default async function ManagerGoogleDrivePage() {
      ...
      {isConnected ? (
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Connect your Google account to access your files and documents directly in the manager portal.
          </p>
